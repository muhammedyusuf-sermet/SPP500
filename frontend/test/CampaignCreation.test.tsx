...
import { CampaignCreation, ICampaignCreationState } from "../src/renderer/components/CampaignCreation";
...
describe('Monster CRUD', () => {
	...
	let campaignCreationInstance: ReactWrapper<any, ICampaignCreationState, CampaignCreation>;
	...
	describe('Redirect if submitted', () => {
		beforeEach(() => {
			...
			campaignCreationInstance = mount<CampaignCreation, any, ICampaignCreationState>(<BrowserRouter><CampaignCreation/></BrowserRouter>);
		})
		...
		it('should redirect', () => {
			...
			campaignCreationInstance.find("CampaignCreation").setState({ submitted: true });
	...
	describe('Happy Path', () => {
		...
		beforeEach(() => {
			...
			CookieManager.RemoveCookie = CookieManagerMock.RemoveCookie.bind(CookieManager);
			CookieManager.SetStringCookie = CookieManagerMock.SetStringCookie.bind(CookieManager);
			campaignCreationInstance = mount<CampaignCreation, any, ICampaignCreationState>(<CampaignCreation/>);
		})
		...
		it('should be able to send campaign name only to create', async (done) => {
			...
			expect(campaignCreationInstance.find('Modal#campaignCreationModal').prop('isActive')).toEqual(true);
		...
		describe('should show and hide modal', () => {
			it('show modal', () => {
				...
				campaignCreationInstance.update();
				expect(campaignCreationInstance.find('Modal#campaignCreationModal').prop('isActive')).toEqual(false);
