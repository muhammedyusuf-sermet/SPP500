...
export class Initialize1551239150121 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "monster" ("Id" SERIAL NOT NULL, "Name" character varying(50) NOT NULL, "Size" "monster_size_enum" NOT NULL DEFAULT 'Medium', "Type" "monster_type_enum" NOT NULL DEFAULT 'Beast', "Race" "monster_race_enum" NOT NULL DEFAULT 'AnyRace', "Alignment" "monster_alignment_enum" NOT NULL DEFAULT 'Unaligned', "ArmorClass" integer NOT NULL DEFAULT 12, "HitPoints" integer NOT NULL DEFAULT 12, "HitPointDistribution" character varying(20) NOT NULL DEFAULT '2d8', "Speed" character varying(100) NOT NULL DEFAULT '30 ft.', "Senses" character varying(250), "Languages" character varying(100), "DamageVulnerabilities" character varying(200), "DamageResistances" character varying(200), "DamageImmunities" character varying(200), "ConditionImmunities" character varying(200), "ChallengeRating" double precision NOT NULL DEFAULT 1, "abilityScoresId" integer, "savingThrowsId" integer, CONSTRAINT "REL_6694bba3a49c923bc0bb5e7b7c" UNIQUE ("abilityScoresId"), CONSTRAINT "REL_64f43c972688bda05f8b2a5a7a" UNIQUE ("savingThrowsId"), CONSTRAINT "PK_71262e4809a6a57c2884adc602a" PRIMARY KEY ("Id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "skill" ("Id" SERIAL NOT NULL, "Name" character varying(50) NOT NULL, "Description" character varying(800) NOT NULL, "abilityScoreId" integer, CONSTRAINT "PK_b07b45d0afe62341ae6694c92de" PRIMARY KEY ("Id"))`);
