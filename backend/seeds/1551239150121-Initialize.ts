...
export class Initialize1551239150121 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TYPE "monster_alignment_enum" AS ENUM('Unaligned', 'AnyAlignment', 'LawfulGood', 'LawfulNeutral', 'LawfulEvil', 'NeutralGood', 'Neutral', 'NeutralEvil', 'ChaoticGood', 'ChaoticNeutral', 'ChaoticEvil')`);
