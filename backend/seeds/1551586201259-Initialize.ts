...
export class Initialize1551588722487 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "action" ("Id" SERIAL NOT NULL, "Name" character varying(50) NOT NULL, "Description" character varying(250) NOT NULL, "HitBonus" integer NOT NULL DEFAULT 0, "Damage" character varying(20), "DamageBonus" integer NOT NULL DEFAULT 0, CONSTRAINT "PK_5af3afdfef0cbd9261cbea8e601" PRIMARY KEY ("Id"))`);
