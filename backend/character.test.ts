...
describe('character tests', async () => {
	...
	describe('character edit tests', async () => {
		...
		test('When a new set of valid campaigns is provided to change', async () => {
			const response = await character.Edit({
				payload: {
					"Id": 1,
					"Name": "same name",
		...
		test('When some campaigns are invalid within a given set of campaigns', async () => {
			const response = await character.Edit({
				payload: {
					"Id": 1,
					"Name": "same name",
		...
		test('When some campaigns are someone else\'s', async () => {
			const response = await character.Edit({
				payload: {
					"Id": 1,
					"Name": "same name",
