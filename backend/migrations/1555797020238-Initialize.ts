...
export class Initialize1555797020238 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "character" ("Id" SERIAL NOT NULL, "Name" character varying(50) NOT NULL, "Level" integer NOT NULL DEFAULT 1, "Race" "character_race_enum" NOT NULL DEFAULT 'Human', "Class" "character_class_enum" NOT NULL DEFAULT 'Fighter', "MaxHealth" integer NOT NULL DEFAULT 20, "ArmorClass" integer NOT NULL DEFAULT 12, "Notes" character varying(1000), "creatorId" integer, CONSTRAINT "PK_d97b91f53abe575b78784228a22" PRIMARY KEY ("Id"))`);
